...
namespace Dreamloft.Game.Minigames.BlockGame
{
	...
	{
		private readonly ShapeKind[] shapeKinds =
		{
			ShapeKind.Line,
			ShapeKind.Line,
			ShapeKind.Line | ShapeKind.Corner,
			ShapeKind.Line | ShapeKind.Corner | ShapeKind.TShape | ShapeKind.ZShape | ShapeKind.Square,
			ShapeKind.Line | ShapeKind.Corner | ShapeKind.TShape | ShapeKind.Arc | ShapeKind.Cross,
		};
